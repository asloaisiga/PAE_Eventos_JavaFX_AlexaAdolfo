...
public class LoginController {
    ...
    private static final String USUARIO_VALIDO = "Sofia";
    ...
    private void loginButtonAction(ActionEvent event) throws IOException {
        ...
        if(usuario.equals(USUARIO_VALIDO) && clave.equals(CLAVE_VALIDA)) {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ni/edu/uam/reto3_artesanias/artesanias-view.fxml"));
